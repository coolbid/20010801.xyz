...
namespace WebApp.Components
{
    ...
    public class Products
    {
        ...
        public int UpdateSingleProduct(int intProId, string strClassId, int intPaixu, string strProName, string strProBianhao, string strProChandi, string strProPrice, string strProPath, string strProKeyDescription, string strProDescription,string strKeywords, int intState, string Paths, string strProDescription1, string strProDescription2)
        {
            Database db = new Database();
            SqlParameter[] param = {
                ...
                db.CreateInParam("@Paths", SqlDbType.NText, 1073741823, Paths),
                db.CreateInParam("@ProDescription1", SqlDbType.NText, 1073741823, strProDescription1),
                db.CreateInParam("@ProDescription2", SqlDbType.NText, 1073741823, strProDescription2)
            };
        ...
        /// <param name="intState"></param>
        /// <returns></returns>
        public int AddSingleProduct(string strClassId, int intPaixu, string strProName, string strProBianhao, string strProChandi, string strProPrice, string strProPath, string strProKeyDescription, string strProDescription, string strKeywords,string strPutdate, int intState,string Paths, string strProDescription1, string strProDescription2)
        {
            Database db = new Database();
            SqlParameter[] param = {
                db.CreateInParam("@ClassId", SqlDbType.NVarChar, 500, strClassId),
                ...
                db.CreateInParam("@State", SqlDbType.Int, 4, intState),
                db.CreateInParam("@Paths", SqlDbType.Text, 1073741823, Paths),
                db.CreateInParam("@ProDescription1", SqlDbType.NText, 1073741823, strProDescription1),
                db.CreateInParam("@ProDescription2", SqlDbType.NText, 1073741823, strProDescription2)
            };
