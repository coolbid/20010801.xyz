...
namespace WebApp.Components
{
    ...
    public class WebSite
    {
        ...
        /// <param name="strContent"></param>
        /// <returns></returns>
        public int UpdateSupport(int intID, string strSupportName, string strTitle, string strWebSite, string strState, string strStateManage)
        {
            Database db = new Database();
            SqlParameter[] param = {
                db.CreateInParam("@ID", SqlDbType.Int, 4, intID),
                db.CreateInParam("@SupportName", SqlDbType.NVarChar,25,strSupportName),
