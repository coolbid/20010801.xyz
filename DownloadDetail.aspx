...
<head runat="server">
    ...
    <%--默认--%>
    <style type="text/css">
        .dpic { background: #f3f5f7; text-align: center; }
        .dpic img { max-width: 300px; max-height: 300px; width: expression(this.width >300 && this.height < this.width ? 300: true); height: expression(this.height > 300 ? 300: true); }
