...
public class fileUp : IHttpHandler, IRequiresSessionState, IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        string[] filetype = { ".doc", ".docx", ".zip", ".pdf", ".txt", ".xls", ".xlsx" };    //文件允许格式
        int size = 10;   //文件大小限制,单位MB,同时在web.config里配置环境默认为100MB
