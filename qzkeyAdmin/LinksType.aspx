<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinksType.aspx.cs" Inherits="Manager_LinksType" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function BackWait()
        {
            if (document.getElementById("txtTypeTitle").value == "") { alert("请输入分类名称！"); document.getElementById("txtTypeTitle").focus(); return false; }
            else
            {
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="left_txt" colspan="2" bgcolor="#f2f2f2" align="left">
                            <a href="LinksType.aspx">分类列表</a> | <a href="LinksType.aspx?Action=Add">添加分类</a>
                            | <a href="Links.aspx">友链列表</a> | <a href="Links.aspx?Action=Add">发布友链</a>
                        </td>
                    </tr>
                </table>
                    ...
                    <asp:GridView ID="gvList" DataKeyNames="id" runat="server" Width="100%" BorderWidth="0"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="分类名称">
                                ...
                                <ItemTemplate>
                                    <a href="Links.aspx?TypeID=<%#Eval("ID") %>">
                                        <%#Eval("TypeTitle")%>
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="pnlEdit" runat="server" Width="100%">
                    <table cellpadding="2" cellspacing="1" border="0" width="100%" align="center">
                        <tr>
                            ...
                            <td class="td_right">
                                <asp:TextBox ID="txtTypeTitle" runat="server" Width="210"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
