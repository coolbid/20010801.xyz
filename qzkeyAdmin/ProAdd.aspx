<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProAdd.aspx.cs" Inherits="Manager_ProAdd"
...
<body>
    ...
    <input runat="server" type="hidden" id="proname" value="" />
    <input runat="server" type="hidden" id="txtCheck" value="" />
    <input runat="server" type="hidden" id="fenlei" value="" />
    ...
    <script type="text/javascript">
        ...
        window.onload = function ()
        {
            ...
            swfu = new SWFUpload({
                ...
                upload_url: "Tools/upload.aspx?fenlei=" + escape($("#fenlei").val()) + "&proname=" + escape($("#proname").val()) + "&Check=" + escape($("#txtCheck").val()),
                post_params: {
