<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubmitForm.aspx.cs" Inherits="Manager_SubmitForm"
        ...
        <tr>
            ...
            <td valign="top" bgcolor="#F7F8F9">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="td_left">
                            HTML代码：<font color='red'>*</font>
                        </td>
                        <td class="td_right">
                            <asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" Width="700" Height="300"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_left_color">
