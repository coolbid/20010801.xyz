        ...
        <tr>
            ...
            <td valign="top" bgcolor="#F7F8F9">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="left_txt" colspan="2" bgcolor="#f2f2f2" align="left">
                                <a href="IM.aspx">QQ列表</a> | <a href="IM.aspx?Action=View" id="A4">→添加QQ</a>
                            </td>
                        </tr>
                    </table>
                            ...
                            <asp:TemplateField HeaderText="设置">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("ID") %>'
                                        OnCommand="LinkButton3_Command"><%#SetState(Eval("State", "{0}"))%></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <asp:Panel ID="pnlShow" runat="server" Visible="false" align="center">
                    目前没有任何数据 <a href="IM.aspx?Action=View">立即设置</a></asp:Panel>
                <!--内容结束-->
            </td>
