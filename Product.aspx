...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="path_bg">
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;&nbsp;<a href="/w83/">Home</a>&nbsp;>&nbsp;<a
                    href="#">
                    <%=strColumnName %>
                </a>
            </div>
                        ...
                        <asp:Repeater ID="DataList2" runat="server">
                            <ItemTemplate>
                                <div class="col-sm-4 col-md-3 col-mm-6 product_img">
                                    <a href="/prodetail/<%#Eval("ProId") %>">
                                        <img src="/<%#Eval("ProPath") %>" class="img-thumbnail" /></a><p class="product_title">
                                            <a href="/prodetail/<%#Eval("ProId") %>">
                                                <%#Eval("ProName")%></a></p>
                                </div>
                            </ItemTemplate>
