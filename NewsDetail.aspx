...
<div class="row">
<div class="path_bg">
<span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;&nbsp;<a href="/">Home</a>&nbsp;>&nbsp;<a href="#"> <%=strParentColumnName %> </a> &nbsp;>&nbsp;<a href="#"> <%=strColumnName %> </a> </div>
<!-- right -->
<div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
<div class="list_box">
<h2 class="left_h"><%=strColumnName %></h2>
<div class="contents">
<h1 class="contents_title">    <asp:Label ID="lblTitle" runat="server"></asp:Label></h1>
<div>  <asp:Label ID="lblContent" runat="server"></asp:Label></div>
<div>
	<br>
</div>
</div>
